...
export function LogoMarkAccentGraphic({ width = 28.6525, height = 36.106 }: { width?: number; height?: number }) {
  return (
...
/** Logo checkmark — Group 1 (white ellipse + strokes + green base) */
export function LogoMarkGraphic({ width = 21.8156, height = 30.6813 }: { width?: number; height?: number }) {
  return (
    <Svg width={width} height={height} viewBox="0 0 21.8156 30.6813">
      <Ellipse cx={14.8248} cy={2.65387} rx={2.4412} ry={2.65387} fill="white" />
      <Path
 ...
 */
export function WordmarkTextGraphic({ width = 83.2, height = 21.8 }: { width?: number; height?: number }) {
  return (
...
export function AppleIconGraphic({ width = 15.1671, height = 18.0023 }: { width?: number; height?: number }) {
  return (
...
export function CardFrameGraphic({
  ...
  return (
    <Svg width={width} height={height} viewBox="0 0 326.4 322.4">
      <Rect x={0.1} y={0.1} width={326.2} height={322.2} rx={10.1} opacity={0.79} fill="#0C0C0C" stroke="#838383" strokeWidth={0.2} />
      {showButtonSlots ? (
        <>
          <Path
