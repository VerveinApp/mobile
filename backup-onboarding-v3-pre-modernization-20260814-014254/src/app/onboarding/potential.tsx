 ...
 * First Look instead (see step-9's branch). No progress bar: this is the
...
export default function OnboardingPotentialScreen() {
  ...
  // continuous reveal instead of two unrelated animations.
    ...
    <View style={styles.root}>
      ...
      <ReanimatedAnimated.View style={styles.fadeLayer} entering={entering}>
        ...
        <View style={styles.overallBlock}>
          ...
          <ReanimatedAnimated.Text entering={FadeIn.duration(300).delay(650)} style={styles.overallLabel}>
            Overall Potential
          </ReanimatedAnimated.Text>
        </View>

        <ReanimatedAnimated.Text entering={FadeIn.duration(350).delay(950)} style={styles.insight}>
        ...
        <View style={styles.trajectoryRow}>
          {result.trajectory.map((point, index) => (
            <ReanimatedAnimated.View
              key={point.label}
              entering={FadeIn.duration(300).delay(1100 + index * 150)}
        ...
        <ReanimatedAnimated.Text entering={FadeIn.duration(350).delay(1550)} style={styles.trajectoryNote}>
